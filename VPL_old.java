...
public class VPL
{
  ...
  public static void main(String[] args) throws Exception {
    ...
    bp = k;  sp = k+2;  ip = 0;  rv = -1;  hp = max;  pushIncrement = 0;
    numPassed = 0;
    
    int codeEnd = bp-1; // the last instruction
...
*/
      ...
      if ( op == labelCode) {
        ...
        mem[sp + pushIncrement] = ip;
        mem[sp + pushIncrement + 1] = bp;
        ip = mem[ip];
        sp = sp + pushIncrement + 2;
      } else if (op == passCode) {
        mem[sp + pushIncrement] = mem[]
      } else if ( op == oppCode ) {
